  ...
  <body>
	 ...
	 <?php include 'cabec.php'; ?>
		...
		<section class="corpo">
			  ...
			  <div id="login">
			  E-mail:<br>
			  <input type="email" name="email" id="nome" class="borders" placeholder="Digite Seu E-mail" required > <br><br>
			  ...
			  <div id="divb">
					  ...
					  <button id="adentrar" class="btn" type="submite">
	...
	<script>
				document.alert(" E-mail ou senha invalido")
		</script>
