...
<html>
  ...
  <body>
	...
	<header id="cabe">
		...
		<center>
	<div class="remember">
			<form  action="veriEmail.php" id="newss" method="post">
			...
			<p class="Insira">Insira seu email para recuperar a senha.</p><br><br>
			<input type="email" id="passwd" name='Ema' class="novapass" placeholder="Insira seu E-mail" required >
